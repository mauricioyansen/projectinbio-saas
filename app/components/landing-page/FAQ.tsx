...
function FAQItem({
  ...
  return (
    <div className="w-[351px] h-min flex flex-col gap-3 p-5 rounded-2xl border border-[var(--border-primary)] bg-[var(--background-primary)]">
      <p className="font-bold text-white">{title}</p>
      <p className="text-[var(--content-body)]">{description}</p>
    </div>
  );
}
